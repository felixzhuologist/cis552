...
> -- return the number of black nodes to each leaf if it's the same for both
> -- children else -1
> prop_Rb3' :: RBT Int -> Int
> prop_Rb3' (N c l _ r) = if (rCount == lCount && rCount /= -1)
>                           then (isBlack + lCount)
>                           else -1
>   where
>     rCount = prop_Rb3' l
>     lCount = prop_Rb3' r
>     isBlack = if c == B then 1 else 0
> prop_Rb3' _ = 1

4. All children of red nodes are black.

> prop_Rb4 :: RBT Int  -> Bool
> prop_Rb4 (N R l _ r) = color l == B && color r == B && prop_Rb4 l && prop_Rb4 r
> prop_Rb4 (N B l _ r) = prop_Rb4 l && prop_Rb4 r
> prop_Rb4 _ = True
